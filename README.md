...
I originally wrote this for the Fedora KDE spin but Chapters 5 & 10 are the only ones here specific to the KDE so users of the base Fedora distro and other spins can use this document too.
