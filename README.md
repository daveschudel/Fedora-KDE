...
- [3. 3) Shells](#3-3-shells)
  - [3.1. Zsh](#31-zsh)
    - [3.1.1. Zsh Tweaks](#311-zsh-tweaks)
    - [3.1.2. Themes](#312-themes)
  - [3.2. Bash](#32-bash)
  - [3.3. Eza](#33-eza)
- [4. 4) DNF \& Repositories](#4-4-dnf--repositories)
  ...
  - [4.7. COPR](#47-copr)
- [5. 5) My Fedora KDE settings \& tweaks](#5-5-my-fedora-kde-settings--tweaks)
...
- [6. 6) Apps \& Packages I'd Recommend](#6-6-apps--packages-id-recommend)
...
- [7. 7) Additional Software Installers](#7-7-additional-software-installers)
  - [7.1. Fedy](#71-fedy)
  - [7.2. DNF Dragora](#72-dnf-dragora)
  - [7.3. Flatpaks](#73-flatpaks)
- [8. 8) Other System Topics](#8-8-other-system-topics)
  - [8.1. SSH](#81-ssh)
  - [8.2. Backups](#82-backups)
  - [8.3. VPN](#83-vpn)
  - [8.4. Laptop Power Management](#84-laptop-power-management)
- [9. 9) SELinux](#9-9-selinux)
- [10. 10) Grub](#10-10-grub)
  - [10.1. Grub Configuration Files](#101-grub-configuration-files)
  - [10.2. Themes](#102-themes)
- [11. 11) Plymouth](#11-11-plymouth)
- [12. 12 Upgrades and Beta versions](#12-12-upgrades-and-beta-versions)
  - [12.1. RPM Fusion](#121-rpm-fusion)
  - [12.2. Upgrading Fedora](#122-upgrading-fedora)
- [13. 13) Problems](#13-13-problems)
  - [13.1. Sound](#131-sound)
- [14. 14) Ham Radio](#14-14-ham-radio)
...
# 5. 5) My Fedora KDE settings & tweaks
...
# 6. 6) Apps & Packages I'd Recommend
...
# 7. 7) Additional Software Installers
...
# 12. 12 Upgrades and Beta versions
